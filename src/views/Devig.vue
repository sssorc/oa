	...
	<div class="devig">
		<header class="section full-width py-12 bg-blue show-md">
			<nav class="flex-center wrap gap-x-32 gap-y-16 contain">
				...
				<a id="HyperLinkDevigger" target="_blank" href="http://www.crazyninjamike.com/Public/sportsbooks/sportsbook_devigger.aspx">Devigger</a>
				<a id="HyperLinkComboBreaker" target="_blank" href="http://www.crazyninjamike.com/Public/sportsbooks/sportsbook_combo_breaker.aspx">C-C-C-Combo Breaker</a>
				<a id="HyperLinkUpByXPromo" target="_blank" href="http://www.crazyninjamike.com/Public/sportsbooks/sportsbook_UpByXPromo.aspx">Up By X Promo Simulator</a>
				<a id="HyperLinkCNMSignup" target="_blank" href="http://www.crazyninjamike.com/Public/sportsbooks/sportsbook_CNM_signup.aspx">CrazyNinjaOdds.com</a>
			</nav>
		</header>
