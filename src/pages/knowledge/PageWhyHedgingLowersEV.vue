...
<template>
    <KnowledgeArticle>
        ...
        <p>
            ...
            on each bet. We can look at the expected results after 1,000 days with different strategies.
        </p>
        ...
        <p>
            ...
            <router-link to="/devig-calculator?finalOdds=595&legOdds=100%2C100%2C100&boost=30">devig calculator</router-link> confirms this by showing that it is a 9.2% EV bet.
        </p>
        ...
        <p class="bg-pale-blue/30 border-jet/10 border p-4 text-sm">
            ...
            <span class="invisible">Unhedged EV</span> = $38.7 - $5<br />
            <span class="invisible">Unhedged EV</span> = $33.7
        </p>
        <p class="bg-pale-blue/30 border-jet/10 border p-4 text-sm">
