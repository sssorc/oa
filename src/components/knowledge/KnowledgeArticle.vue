<template>
    <article class="mx-auto w-full max-w-4xl px-5 py-12">
        ...
        <router-link
            to="/knowledge"
            class="text-space-gray border-jet decoration-none hover:ring-ice-blue hover:bg-green/10 mt-6 inline-flex items-center gap-2 rounded-sm border p-2 text-sm ring ring-transparent ring-offset-2 ring-offset-transparent transition-all duration-100"
        >
